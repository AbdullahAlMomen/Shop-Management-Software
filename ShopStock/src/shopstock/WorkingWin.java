 ...
 * @author User
 */
public class WorkingWin extends javax.swing.JFrame {

    /**
     * Creates new form WorkingWin
     */
    String User;
    public WorkingWin(String user) {
        initComponents();
        User=user;
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/shopstock/power_off.png"))); // NOI18N
        ...
        jButton4.setText("DateWise Stock");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WorkingWin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WorkingWin().setVisible(true);
            }
        });
    }
